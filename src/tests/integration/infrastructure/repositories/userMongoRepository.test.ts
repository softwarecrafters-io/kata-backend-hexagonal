...
import {initializeDatabase, UserMongoRepository} from "../../../../infrastructure/repositories/userMongoRepository";
...
describe('The User File Repository', ()=>{
    ...
    let db : Db;
    beforeEach(async ()=>{
        db = await initializeDatabase('mongodb://localhost:27017', 'test')
        repo = new UserMongoRepository(db);
    });
